...
export default function MapBox({mapbox_access_token,viewState,onViewStateChange,children} : {mapbox_access_token: string,viewState: {latitude: number,longitude: number,zoom?: number,pitch?: number,heading?: number,bearing?: number},onViewStateChange: (newViewState: any) => void,children: React.ReactNode}) {
    return (
        <Map
            antialias
            {...viewState}
